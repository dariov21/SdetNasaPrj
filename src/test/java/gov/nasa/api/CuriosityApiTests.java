...
public class CuriosityApiTests extends CuriosityTest {

    @Test(testName = "Retrieve the first 10 Mars photos made by \"Curiosity\" on 1000 Martian sol." ,groups = { "functional", "api"})
    ...
    @Test(testName = "Retrieve the first 10 Mars photos made by \"Curiosity\" on Earth date equal to 1000 Martian sol.", groups = { "functional", "api"})
    ...
    @Test(testName = "Retrieve and compare the first 10 Mars photos made by \"Curiosity\" on 1000 sol and on Earth date equal to 1000 Martian sol.", groups = { "functional", "api"})
    ...
    @Test(testName = "Validate that the amounts of pictures that each \"Curiosity\" camera took on 1000 Mars sol is not greater than 10 times the amount taken by other cameras on the same date.", groups = { "functional", "api"})
